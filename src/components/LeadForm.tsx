    ...
    <div className="cs-form w-full max-w-[640px] overflow-hidden rounded-2xl border border-skyblue/12 bg-[#0F1F3A] text-white shadow-[0_40px_120px_-40px_rgba(0,0,0,0.6)]">
      ...
      <style>{`
        .cs-input {
          ...
          border: 1px solid rgba(252,217,221,0.2);
          border-radius: 8px;
          padding: 12px 16px;
          font-size: 14px;
          color: #fff;
        ...
        .cs-input:focus { border-color: #EF4F5F; }
        ...
        .cs-option {
          ...
          border: 1px solid rgba(252,217,221,0.15);
          border-radius: 10px;
          padding: 14px 16px;
          cursor: pointer;
          transition: all .2s;
        ...
        .cs-option:hover { border-color: #EF4F5F; background: rgba(239,79,95,0.1); }
        .cs-option.selected { border-color: #E53935; background: rgba(229,57,53,0.08); }
        .cs-option-mark {
          width: 18px; height: 18px;
          border-radius: 4px;
          border: 1.5px solid rgba(252,217,221,0.3);
        ...
        .cs-btn-back:hover { border-color: #FCD9DD; background: rgba(252,217,221,0.05); }
        .cs-btn-next {
          background: #E53935;
          border: none;
          color: #fff;
        ...
        .cs-nav {
          ...
          border-top: 1px solid rgba(252,217,221,0.08);
          gap: 12px;
        }
      `}</style>
    </div>
  ...
  return (
    <div className="py-6 text-center">
      ...
      <button
        type="button"
        onClick={onWhatsApp}
        className="mt-6 inline-flex items-center gap-2 rounded-lg bg-[#EF4F5F] px-6 py-3 text-[13px] font-bold uppercase tracking-wider text-white hover:bg-[#EF4F5F]/90"
      >
