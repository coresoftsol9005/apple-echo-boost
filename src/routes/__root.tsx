...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/4d5e8012-6852-4a57-8ecc-4a075d343c76" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/4d5e8012-6852-4a57-8ecc-4a075d343c76" },
    ...
    links: [
      ...
      // (shortens the critical request chain), then apply it non-blocking.
      {
        rel: "preload",
        as: "style",
        href: "https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700;800;900&family=DM+Mono:wght@400;500&display=swap",
